...
<div class="wj-form__field">
    <context-field-drop-down 
        ...
        v-bind:searchconfig="{field: 'text', api: formvacsearch.self.api, initial: formvacsearch.self.$props.init.text}"
        ...
        <article slot="toggler" slot-scope="cfdd" class="context-search-dropdown__field">
            ...
            <input v-model="cfdd.self.searchvalue" type="text" name="text" id="vacancy-search-text"
