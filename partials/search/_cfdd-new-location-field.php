...
<div class="wj-form__field">
    <cfdd-new 
        ...
        v-bind:searchconfig="{field: 'location', api: self.api}"
        ...
        <article slot="toggler" slot-scope="{parent: parent}" class="context-search-dropdown__field">
            <label for="vacancy-search-text">CFDD-New Местоположение</label>
            <input v-model="parent.searchvalue" type="text" name="vacancy-search-location" id="vacancy-search-location"
