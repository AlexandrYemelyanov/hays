<?php
/*
Template name: Служебная - Сообщение отправлено
*/
?>
<?php
//get_header();
...
$mail->Username = 'anatoliy.dovgun@gmail.com';  // SMTP username
$mail->Password = 'Anatoliy380990293439!';    // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to
$mail->SetFrom(get_field('email_admin', 'option'));
$mail->AddReplyTo(get_field('email_admin', 'option'));
$mail->AddAddress($_GET['your-email']);

//echo $_GET['your-email'];
$mail->Subject = "Спасибо! Вы подписаны на мероприятия Hays";
/*Body empty*/
$mail->MsgHTML('
        ...
        <title>Спасибо! Вы подписаны на мероприятия Hays</title>
...
<main class="blog-page-content wj-container-fixed page-messages-send-ok">
        ...
        <section class="wj-form-wrapper form-common-on-page">
        	...
        	<div class="container">
            	...
            	<div class="row">
					...
					if(!$mail->Send()) {
					    echo "<p class='error'>".get_field('feedback_answer_ok', 'option')."</p>";
					} else {
					    echo "<p class='success'>".get_field('feedback_answer_ok', 'option')."</p>";
